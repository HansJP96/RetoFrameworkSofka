package com.automationpractice.webproject.test.helpers.createanaccount;
...
public class CreateAnAccountHelper {
    ...
    public static String getProperty(String property) {
        ...
        try (FileReader fileReader = new FileReader(CONFIGURATION_PROPERTIES_FILE)) {
            ...
            Report.reportFailure("Failed to query a file property"
    ...
    public static Customer generateCustomer(String language, String country, String emailDomain){
        ...
        customer.setPostalCode(faker.number().digits(5));
